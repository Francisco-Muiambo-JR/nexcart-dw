...
# Descrição: Dashboard interactivo NexCart com filtros
...
def load_dados():
    query = """
        SELECT
            ...
            f.unit_price                    AS preco,
            f.discount_pct                  AS desconto,
            f.net_revenue                   AS receita_liquida,
...
# ============================================================
# GRÁFICO 2 — PRODUTOS E CATEGORIAS
# ============================================================
...
# ============================================================
# GRÁFICO 4 — SEGMENTOS DE CLIENTES
# ============================================================
...
fig6 = px.bar(
    df_seg.sort_values("receita_liquida", ascending=False),
    x="segmento",
    y="receita_liquida",
...
df_tabela = df_filtrado[[
    "order_id", "full_date", "cliente", "produto",
    "categoria", "cidade", "canal", "quantidade",
    "preco", "desconto", "receita_liquida"
